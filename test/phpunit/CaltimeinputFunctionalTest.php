...
/**
 * \file    test/phpunit/CaltimeinputFunctionalTest.php
...
/**
 * Class CaltimeinputFunctionalTest
 *
 ...
 *
 * @package Testcaltimeinput
 */
class CaltimeinputFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCaltimeinput')->click();
		} else {
			// Disable the module
			$this->byHref('modCaltimeinput')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/caltimeinput/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('caltimeinput/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/caltimeinput/admin/about.php');
		$this->authenticate();
		return $this->assertContains('caltimeinput/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('caltimeinputwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCaltimeinput_CaltimeinputTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCaltimeinput_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
